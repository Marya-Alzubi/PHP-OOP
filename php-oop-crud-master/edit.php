  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 mt-5">
        <h1 class="text-center">PHP - OOP CRUD EXERCISE - Update -edit & update- </h1>
    ...
    <div class="row">
      <div class="col-md-5 mx-auto">
        ...
        if (isset($_POST['update'])) {
          if (!empty($_POST['name']) && !empty($_POST['email']) && !empty($_POST['mobile']) && !empty($_POST['password']) && !empty($_POST['address'])) {
            ...
            if ($update) {
              ...
              $_SESSION['edited'] = "The record updated successfully";
              header("location:records.php");
            } else {
              $_SESSION['edited'] = "The record did not update successfully";
              header("location:records.php");
            }
          } else {
        ...
        <form action="" method="post">
          ...
          <div class="form-group text-center m-2 ">
            <a href="records.php"><button type="submit" name=cancel" class="btn btn-secondary ">Cancel</button></a>
          </div>
          </div>
        </form>
      </div>
